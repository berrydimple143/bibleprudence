<div class="bg-black text-white p-3 absolute sticky bottom-0 flex flex-col items-center">
    <div class="flex flex-wrap items-center gap-3 justify-center text-sm px-4 pb-2 border-b border-gray-600 border-dashed">
        ...
        <div>|</div>
        <a wire:navigate href="{{ route('terms') }}" class="@if($page == 'terms') text-green-400 @endif">Terms and Conditions</a>
        <div>|</div>
        <a wire:navigate href="{{ route('disclaimer') }}" class="@if($page == 'disclaimer') text-green-400 @endif">Disclaimer</a>        
    </div>
