      ...
      <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          ...
          <div class="text-gray-600">
            <p class="font-medium text-lg">Expense Details</p>
          ...
          <div class="lg:col-span-2"> 
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">             
              ...
              <div class="md:col-span-2">
                <label for="date_issued">Date Disbursed</label>
              ...
              <div class="md:col-span-5">
                <label for="given_to">Received by (Optional)</label>
                <input wire:model="given_to" type="text" name="given_to" id="given_to" class="h-10 border border-gray-400 mt-1 rounded px-4 w-full bg-gray-50 @error('given_to') border-red-500 @enderror" placeholder="Type received by here ..." />
                @error('given_to')
                  <p class="text-red-500">{{ $message }}</p>
                @enderror
              </div>        
