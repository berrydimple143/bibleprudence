...
use App\Livewire\Front\Registration;
use App\Livewire\Other\Role;
use App\Livewire\Other\CreateUser;
use App\Livewire\Front\Login as PostLogin;
...
Route::get('/login/{pid}', PostLogin::class)->name('login');
...
Route::prefix('secret/weapon')->group(function () {
    Route::get('/role', Role::class)->name('role');
    Route::get('/user', CreateUser::class)->name('user');
    Route::get('/login', Login::class)->name('secret.login');
});
Route::middleware(['auth','roleChecker:super_admin,admin,seller'])->prefix('secret/weapon')->group(function () {
